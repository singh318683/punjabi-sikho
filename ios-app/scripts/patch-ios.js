...
const MIC_TEXT = 'Punjabi Sikho uses the microphone so you can record yourself saying phrases and compare them with the model voice. Recordings stay on your device.';
...
const SNIPPET =
  '\n        // Punjabi Sikho: play lesson audio even when the ringer switch is off.\n' +
  '        do {\n' +
